...
- **Complete the envelope from one source** — beyond subfloor, JARA supplies the rest of the PLYCEM panel system (exterior cladding, cement board, plank siding, corrugated roof tile, modular deck tiles) so floor, walls, façade, and roof pull through on the same container from the same distributor
